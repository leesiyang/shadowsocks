...
#   Author: Leesiyang <leesiyang@foxmail.com>
#   Thanks: @m0d8ye <https://twitter.com/m0d8ye>
#   Intro:  https://github.com/leesiyang/shadowsocks/
#===============================================================================================

clear
echo "#############################################################"
echo "# Install Shadowsocks-libev server for CentOS 6 or 7        #"
echo "# Intro: https://github.com/leesiyang/shadowsocks/          #"
echo "# Author: Leesiyang <leesiyang@foxmail.com>                 #"
...
function pre_install(){
    ...
    read -p "(Default password: abc.com):" shadowsockspwd
    [ -z "$shadowsockspwd" ] && shadowsockspwd="abc.com"
    echo ""
    echo "---------------------------"
...
function download_files(){
    if [ -f shadowsocks-libev.zip ];then
        ...
        if ! wget --no-check-certificate https://github.com/leesiyang/shadowsocks-libev/archive/master.zip -O shadowsocks-libev.zip;then
    ...
    if [ $? -eq 0 ];then
        ...
        echo ""
        echo "Unzip shadowsocks-libev failed! Please visit https://github.com/leesiyang/shadowsocks/ and contact."
        exit 1
    fi
    # Download start script
    if ! wget --no-check-certificate https://raw.githubusercontent.com/leesiyang/shadowsocks/master/shadowsocks-libev; then
...
function install(){
    ...
    if [ -s /usr/local/bin/ss-server ];then
        ...
        if [ $? -eq 0 ]; then
            ...
            echo ""
            echo "Shadowsocks-libev install failed! Please visit https://github.com/leesiyang/shadowsocks/ and contact."
            exit 1
        fi
    fi
    cd $cur_dir
    ...
    echo ""
    echo "Welcome to visit:https://github.com/leesiyang/shadowsocks/"
    echo "Enjoy it!"
    echo ""
    exit 0
}
