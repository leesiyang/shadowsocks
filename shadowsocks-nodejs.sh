...
function download_files(){
    ...
    if [ $? -eq 0 ];then
        ...
        echo ""
        echo "Untar Nodejs failed! Please visit https://github.com/leesiyang/shadowsocks/ and contact."
        exit 1
    fi
}
...
function install(){
    ...
    if [ $? -eq 0 ]; then
        ...
        echo ""
        echo "Nodejs install failed! Please visit https://github.com/leesiyang/shadowsocks/ and contact."
        exit 1
    fi
    ...
    if [ -s /usr/local/bin/ssserver ]; then
        ...
        echo ""
        echo "Shadowsocks-nodejs install failed! Please visit https://github.com/leesiyang/shadowsocks/ and contact."
        exit 1
    fi
